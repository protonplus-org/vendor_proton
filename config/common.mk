...
# Backup Tool
PRODUCT_COPY_FILES += \
    vendor/proton/prebuilt/common/bin/backuptool.sh:install/bin/backuptool.sh \
    vendor/proton/prebuilt/common/bin/backuptool.functions:install/bin/backuptool.functions \
    vendor/proton/prebuilt/common/bin/50-proton.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-proton.sh

PRODUCT_ARTIFACT_PATH_REQUIREMENT_ALLOWED_LIST += \
    system/addon.d/50-proton.sh

ifneq ($(strip $(AB_OTA_PARTITIONS) $(AB_OTA_POSTINSTALL_CONFIG)),)
PRODUCT_COPY_FILES += \
    vendor/proton/prebuilt/common/bin/backuptool_ab.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.sh \
    vendor/proton/prebuilt/common/bin/backuptool_ab.functions:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_ab.functions \
    vendor/proton/prebuilt/common/bin/backuptool_postinstall.sh:$(TARGET_COPY_OUT_SYSTEM)/bin/backuptool_postinstall.sh
